...
Public Partial Class DashboardForm
	...
	Public Sub New()
        ...
        Using ms As New System.IO.MemoryStream(Resources.RedJet)
	...
	Public Function GetHardwareId() As String
        ...
        Using hardwareidtxt As System.IO.Stream = System.IO.File.Open("Hwid.txt", System.IO.FileMode.Open, System.IO.FileAccess.Read, System.IO.FileShare.ReadWrite)
